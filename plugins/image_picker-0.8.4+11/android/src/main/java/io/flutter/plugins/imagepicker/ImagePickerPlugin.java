...
public class ImagePickerPlugin
    ...
    private static final int SOURCE_FRONT_IDImage = 2;
    private static final int SOURCE_BACK_IDImage = 3;
            ...
            case METHOD_CALL_IMAGE:
                ...
                switch (imageSource) {
                    ...
                    case SOURCE_CAMERA:
                        ...
                        break;
                    case SOURCE_FRONT_IDImage:
                        delegate.takeFRONT_IDImageWithCamera(call, result);
                        break;
                    case SOURCE_BACK_IDImage:
                        delegate.takeBACK_IDImageWithCamera(call, result);
                        break;
                    default:
